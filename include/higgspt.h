...
class HiggsDpT {
 public:
  HiggsDpT(int order, int channel, std::string pdfname, void *params);
  ...
  double delta(double pt, double tm, double t, double y1, double y2, double yc);

  double distr(double pt, double tm, double y1, double y2, double zz1,
               double zz2, double zz3);

  double distrcross(double pt, double tm, double y1, double y2, double zz1,
                    double zz2, double zz3);
