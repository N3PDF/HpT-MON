 ...
 *       Filename:  hadronic.h
 *
 *    Description:  Header file for the hadronic.cpp file which computes the full
 *                  hadronic cross section in x space.
 *
 *        Version:  1.0
...
class HadronicHiggs {
 public:
    ...
    std::vector<double> higgsdpt(
            double pt,
            double y1,
            double y2);

    double ExtractDeltaHadronic(
            double pt,
            double tm,
            double t,
            double y1,
